...
class App {
    ...
    setupGlobalNavigation() {
        ...
        globalLinks.forEach(link => {
            link.addEventListener('click', (e) => {
                ...
                switch (unit) {
                    case 'qa': this.render('qa-dashboard', { title: 'Quality Assurance Unit' }); break;
    ...
    renderQualityUnit(activeTab = 'strategic') {
        ...
        const pharmdGoals = [
            {
                ...
                branches: [
                    { name: '1.1 Planning', kpis: [{ name: 'Plan Indicators Achieved', target: '80%', actual: '75%' }] }
                ]
            },
            {
                ...
                branches: [
                    {
                        name: '2.1 Governance', kpis: [
                            { name: 'Advisory Meetings', target: '1', actual: '2' },
                        ]
                    },
                    {
                        name: '2.2 Evaluation', kpis: [
                            { name: 'Course Evals Done', target: '100%', actual: '98%' }
                        ]
                    }
                ]
            },
            {
                ...
                branches: [
                    {
                        name: '3.1 Quality', kpis: [
                            { name: 'Learn Exp Satis.', target: '4/5', actual: '3.9/5' },
                            { name: 'Course Qual Satis.', target: '3.5/5', actual: '3.7/5' }
                        ]
                    },
                    {
                        name: '3.3 Outcomes', kpis: [
                            { name: 'Completion Rate', target: '80%', actual: '85%' },
                            { name: 'Retention Rate', target: '80%', actual: '79%' },
                            { name: 'SPLE Pass Rate', target: '90%', actual: '94%' },
                            { name: 'Employability', target: '80%', actual: '76%' },
                            { name: 'Avg Class Size', target: '40', actual: '38' },
                            { name: 'Employer Satis.', target: '4/5', actual: '4.2/5' }
                        ]
                    }
                ]
            },
                ...
                branches: [
                    {
                        name: '4.1 Services', kpis: [
                            { name: 'Service Satis.', target: '3.5/5', actual: '3.6/5' },
                            { name: 'Clinical Rot Satis.', target: '3.5/5', actual: '3.8/5' }
                        ]
                    },
                    {
                        name: '4.3 Support', kpis: [
                            { name: 'Counseling Benefit', target: '50%', actual: '48%' },
                            { name: 'Conf Projects Acc.', target: '80%', actual: '70%' }
                        ]
                    }
                ]
            },
                ...
                branches: [
                    {
                        name: '5.1 Ratios', kpis: [
                            { name: 'Student:Staff', target: '10:1', actual: '11:1' },
                            { name: 'Student:Practitioner', target: '3:1', actual: '3:1' },
                            { name: 'Preceptor Satis.', target: '4/5', actual: '4.3/5' }
                        ]
                    },
                    {
                        name: '5.4 Diversity', kpis: [
                            { name: 'Faculty Dist.', target: '100%', actual: '95%' },
                            { name: 'Turnover Rate', target: '5%', actual: '4%' }
                        ]
                    },
                    {
                        name: '5.6 Research', kpis: [
                            { name: 'Publication %', target: '80%', actual: '75%' },
                            { name: 'Pub Rate/Fac', target: '3', actual: '2.8' },
                            { name: 'Citations/Fac', target: '30', actual: '28' },
                            { name: 'Median H-Index', target: '5', actual: '6' }
                        ]
                    },
                    {
                        name: '5.10 Dev', kpis: [
                            { name: 'Faculty Training', target: '4', actual: '5' },
                            { name: 'Comm Service', target: '4', actual: '7' }
                        ]
                    }
                ]
            },
                ...
                branches: [
                    {
                        name: '6.1 Resources', kpis: [
                            { name: 'Resource Satis.', target: '4/5', actual: '4.1/5' }
                        ]
                    }
                ]
            }
        ...
        const tabs = [
            ...
            { id: 'surveys', label: '📝 Surveys Center' },
        ...
        if (activeTab === 'strategic') {
            ...
            content = `
                ...
                b.kpis.map((k, kIndex) => `
                                                        <tr>
                                                            ${kIndex === 0 ? `<td rowspan="${b.kpis.length}" style="vertical-align: top; font-weight: 500;">${b.name}</td>` : ''}
                                                            <td>${k.name}</td>
                                                            <td><input type="text" class="input-field kpi-target" value="${k.target}" style="padding:4px; font-size:0.9rem;"></td>
                                                            <td><input type="text" class="input-field kpi-actual" value="${k.actual}" style="padding:4px; font-size:0.9rem; font-weight:bold;"></td>
                                                            <td class="kpi-status">${k.actual.includes('Prog') || k.actual.includes('Pending') ? '🟡' : (parseFloat(k.actual) >= parseFloat(k.target) ? '🟢' : '🔴')}</td>
            ...
            content = `
                <div class="card">
                    <h3>🎓 PharmD Program Learning Outcomes (PLO)</h3>
                    <p class="text-muted">Cohort performance across 10 CAPE Outcomes</p>
                    <div style="height: 400px;"><canvas id="chartPLO"></canvas></div>
                </div>
            `;
            initCharts = () => {
                new Chart(document.getElementById('chartPLO'), {
                    type: 'bar',
                    data: {
                        labels: ['1.1 Learner', '2.1 Caregiver', '2.2 Manager', '3.1 Problem Solver', '3.2 Educator', '3.3 Advocate', '3.4 Collaborator', '3.5 Includer', '4.1 Self-Aware', '4.4 Professional'],
                        datasets: [
                            { label: 'Expectation', data: [3.5, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5, 3.5], type: 'line', borderColor: '#e91e63', borderDash: [5, 5] },
                            { label: 'Cohort Avg', data: [3.8, 4.2, 3.6, 3.9, 4.1, 3.7, 4.3, 3.9, 4.0, 4.5], backgroundColor: '#009688' }
                        ]
                    },
            ...
            const surveys = [
                { title: 'Course Evaluation', type: 'Student', response: '85%', status: 'Completed', score: '4.2/5' },
                { title: 'Student Experience', type: 'Student', response: '78%', status: 'Active', score: '4.0/5' },
                { title: 'Program Evaluation', type: 'Student', response: '92%', status: 'Completed', score: '4.5/5' },
                { title: 'Faculty Experience', type: 'Faculty', response: '88%', status: 'Completed', score: '4.1/5' },
                { title: 'Employee Satisfaction', type: 'Staff', response: '95%', status: 'Completed', score: '4.3/5' },
                { title: 'Employers Satisfaction', type: 'External', response: '60%', status: 'Pending', score: '-' },
                { title: 'Alumni Survey', type: 'Alumni', response: '45%', status: 'Active', score: '4.6/5' }
            ];
                ...
                <div class="dashboard-grid" style="grid-template-columns: repeat(auto-fill, minmax(250px, 1fr));">
                    ${surveys.map(s => `
                        <div class="card" style="border-left: 4px solid var(--primary-gold);">
                            <h4>${s.title}</h4>
                            <span class="badge" style="background:#eee; color:#333; margin:0.5rem 0; display:inline-block;">${s.type} Survey</span>
                            <div style="display:flex; justify-content:space-between; margin: 1rem 0;">
                                <div><strong>Response Rate:</strong><br>${s.response}</div>
                                <div><strong>Avg Score:</strong><br>${s.score}</div>
                            </div>
                            <button class="btn btn-outline" style="width:100%" onclick="alert('Viewing Report for ${s.title}')">📄 View Report</button>
                        </div>
                    `).join('')}
                </div>
            `;
