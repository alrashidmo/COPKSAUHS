...
(function () {
    ...
    /* ── Password gate ────────────────────────────────────────── */
    const _EDIT_PASSWORD = 'COP@2026';

    function _requirePassword() {
        return new Promise(resolve => {
            // Remove any existing modal
            const old = document.getElementById('_appe_pwd_modal');
            if (old) old.remove();

            const overlay = document.createElement('div');
            overlay.id = '_appe_pwd_modal';
            ...
            overlay.innerHTML = `
                <div style="background:#fff;border-radius:16px;padding:2rem 2.5rem;
                    ...
                    <input id="_appe_pwd_input" type="password" placeholder="Password"
                    ...
                    <div id="_appe_pwd_err" style="color:#c62828;font-size:0.8rem;min-height:18px;margin-bottom:0.75rem;"></div>
                    <div style="display:flex;gap:0.75rem;justify-content:center;">
                        <button id="_appe_pwd_cancel"
            ...
            const input   = document.getElementById('_appe_pwd_input');
            const errEl   = document.getElementById('_appe_pwd_err');
            const btnOk   = document.getElementById('_appe_pwd_confirm');
            const btnCancel = document.getElementById('_appe_pwd_cancel');
