-- ===================================
-- APPE Hub Database Setup (CLEAN INSTALL)
-- Run this SQL in Supabase SQL Editor
-- This version safely removes old policies and recreates everything
-- ===================================
...
-- Drop all old RLS policies if they exist
...
-- 3. UPDATE SUBMITTED TICKETS TABLE (add new columns if not exist)
...
-- Add user_id column if it doesn't exist (safe upgrade from old schema)
DO $$
BEGIN
...
-- 2. Run the SQL below to add admin profile (replace the values):
--
-- INSERT INTO user_profiles (user_id, email, full_name, account_type, is_approved)
-- VALUES (
--     'YOUR_USER_ID_FROM_AUTH_DASHBOARD',
--     'admin@ksauhs.edu.sa',
--     'Admin Name',
--     'admin',
--     true
